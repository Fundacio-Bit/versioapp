...
<div>
  ...
  <c:if test="${empty loginInfo}">
     ...
     <li style="list-style-type: disc; list-style-position: inside;">
          <a href="<c:url value="/public/versions/list"/>">
            <span style="${(fn:contains(url, '/public/versions'))? "font-weight: bold;" : ""}">Llistat de Versions XYZ</span>
          </a>
        </li>
         ...
         <li style="list-style-type: disc; list-style-position: inside;">
          <a href="<c:url value="/public/versionsaplicacio/list"/>">
            <span style="${(fn:contains(url, '/public/versionsaplicacio'))? "font-weight: bold;" : ""}">Versions d'Aplicacions XYZ</span>
          </a>
        </li>
