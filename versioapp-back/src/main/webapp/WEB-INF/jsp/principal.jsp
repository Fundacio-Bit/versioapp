...
<br/>
<center>
<img src="<c:url value="/img/app-logo.png"/>"  alt="VersioApp" title="VersioApp"/>
...
&#36;{ver:hasRole(ROLE_ADMIN)}= ${ver:hasRole('ROLE_ADMIN')}<br/>
&#36;{ver:hasRole(ROLE_USER) }= ${ver:hasRole('ROLE_USER') }<br/>
...
<c:if test="${ver:isDesenvolupament()}">
