package org.fundaciobit.versioapp.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.fundaciobit.versioapp"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new org.fundaciobit.versioapp.back.utils.VersioAppSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new org.fundaciobit.versioapp.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new org.fundaciobit.versioapp.back.utils.VersioAppCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new org.fundaciobit.versioapp.back.utils.VersioAppMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/versioapp_genapp", "/WEB-INF/classes/genapp");
