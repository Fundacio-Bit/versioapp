...
import org.fundaciobit.versioapp.persistence.validator.TraduccioValidator;
...
public class TraduccioWebValidator extends AbstractWebValidator<TraduccioForm, Traduccio>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.versioapp.ejb.TraduccioService.JNDI_NAME)
