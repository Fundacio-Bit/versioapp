...
import org.fundaciobit.versioapp.ejb.TraduccioService;
import org.fundaciobit.genapp.common.i18n.I18NException;
import org.fundaciobit.versioapp.model.fields.TraduccioFields;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    List<org.fundaciobit.versioapp.model.entity.Traduccio> traduccions = traduccioEjb.select(where);
    ...
    for (org.fundaciobit.versioapp.model.entity.Traduccio traduccio : traduccions) {
      org.fundaciobit.versioapp.persistence.TraduccioJPA traduccioJPA = (org.fundaciobit.versioapp.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      org.fundaciobit.versioapp.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
