 ...
 *
 */
public class VersioAppSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.versioapp.commons.utils.Configuracio.getDefaultLanguage();
			}
