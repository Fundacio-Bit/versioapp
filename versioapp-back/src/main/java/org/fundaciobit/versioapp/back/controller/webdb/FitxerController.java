...
import org.fundaciobit.versioapp.back.form.webdb.FitxerForm;

import org.fundaciobit.versioapp.back.validator.webdb.FitxerWebValidator;
...
public class FitxerController
    extends org.fundaciobit.versioapp.back.controller.VersioAppBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = org.fundaciobit.versioapp.ejb.FitxerService.JNDI_NAME)
  protected org.fundaciobit.versioapp.ejb.FitxerService fitxerEjb;
