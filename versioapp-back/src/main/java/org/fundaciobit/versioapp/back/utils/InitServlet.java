...
import org.fundaciobit.versioapp.hibernate.HibernateFileUtil;
import org.fundaciobit.versioapp.commons.utils.Constants;
import org.fundaciobit.versioapp.logic.utils.I18NLogicUtils;
import org.fundaciobit.versioapp.logic.utils.LogicUtils;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            if (fd == null) {
                throw new Exception("No s'ha definit la propietat de la ubicació dels fitxers ("
                        +  "org.fundaciobit.versioapp.filesdirectory)") ;
            }
            if (!fd.exists()) {
        ...
        try {
            ...
            String[] basenames = { "missatges", // /WEB-INF/classes/
                    "logicmissatges", "genapp", "versioapp_genapp" };
            ...
            if (plugins == null || plugins.size() == 0) {
                ...
                for (Class<? extends IExportDataPlugin> class1 : plugins) {
                    ...
                    if (edp == null) {
                        ...
                        DataExporterManager.addDataExporter(new org.fundaciobit.versioapp.back.utils.VersioAppDataExporter(edp));
                    }
                }
            }
        ...
        try {
            log.info("VersioApp Version: " + ver);
        } catch (Throwable e) {
            log.info("VersioApp Version: " + ver);
        }
