 ...
 */
@Controller
public abstract class VersioAppFilesBaseController<I extends IGenAppEntity,PK extends Object,F extends BaseForm> extends CommonFilesBaseController<I,PK,F,Fitxer>{
	...
	getFilesFormManager() {
    return new VersioAppFilesFormManager(fitxerEjb);
  }
