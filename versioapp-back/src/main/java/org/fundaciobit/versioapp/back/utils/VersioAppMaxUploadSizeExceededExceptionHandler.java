 ...
 * 
 */
public class VersioAppMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof VersioAppMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof VersioAppMaxUploadSizeExceededException) {
          msgCode = ((VersioAppMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
