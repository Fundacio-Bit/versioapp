package org.fundaciobit.versioapp.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("org.fundaciobit.versioapp.hibernate")) {
	        		projecteProperties.put(kStr.replace("org.fundaciobit.versioapp.",""), v.toString());
