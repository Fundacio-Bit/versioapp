...
@Table(name = "ver_traducciomap" , indexes = { 
        @Index(name="ver_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="ver_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
