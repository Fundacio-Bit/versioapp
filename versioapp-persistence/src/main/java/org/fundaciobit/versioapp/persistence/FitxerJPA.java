...
@Table(name = "ver_fitxer" , indexes = { 
        @Index(name="ver_fitxer_pk_i", columnList = "fitxerid")})
@SequenceGenerator(name="FITXER_SEQ", sequenceName="ver_fitxer_seq", allocationSize=1, initialValue=1000)
...
public class FitxerJPA implements Fitxer {
  ...
  void postLoad() {
    if (threadLocal.get() != null) {
      this.encryptedFileID = org.fundaciobit.versioapp.hibernate.HibernateFileUtil.encryptFileID(fitxerID);
    }
  }
