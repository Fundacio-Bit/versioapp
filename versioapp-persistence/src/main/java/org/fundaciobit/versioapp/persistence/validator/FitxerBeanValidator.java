...
public class FitxerBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.versioapp.model.dao.IFitxerManager __fitxerManager;


  public final FitxerValidator<FitxerJPA> _validator;


  public FitxerBeanValidator(org.fundaciobit.versioapp.model.dao.IFitxerManager __fitxerManager) { 
  ...
  public FitxerBeanValidator(FitxerValidator<FitxerJPA> _validator,
     org.fundaciobit.versioapp.model.dao.IFitxerManager __fitxerManager) {
    this.__fitxerManager = __fitxerManager;
