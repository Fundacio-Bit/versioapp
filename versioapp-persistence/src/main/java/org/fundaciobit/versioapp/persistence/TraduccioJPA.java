...
@Table(name = "ver_traduccio" , indexes = { 
        @Index(name="ver_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="ver_traduccio_seq", allocationSize=1, initialValue=1000)
...
public class TraduccioJPA implements Traduccio {
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = org.fundaciobit.versioapp.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="ver_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="ver_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, org.fundaciobit.versioapp.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, org.fundaciobit.versioapp.persistence.TraduccioMapJPA>();

  public Map<String, org.fundaciobit.versioapp.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, org.fundaciobit.versioapp.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.versioapp.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.versioapp.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.versioapp.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
