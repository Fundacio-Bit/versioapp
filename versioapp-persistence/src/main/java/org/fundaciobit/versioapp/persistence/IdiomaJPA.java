...
@Table(name = "ver_idioma" , indexes = { 
        @Index(name="ver_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="ver_idioma_seq", allocationSize=1, initialValue=1000)
