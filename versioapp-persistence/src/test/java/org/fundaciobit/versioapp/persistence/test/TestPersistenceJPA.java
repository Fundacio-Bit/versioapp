package org.fundaciobit.versioapp.persistence.test;
...
import org.fundaciobit.versioapp.persistence.VersioAppJPADaoManagers;
import org.fundaciobit.versioapp.model.VersioAppDaoManager;
...
public class TestPersistenceJPA {
    ...
    public static final void main(String[] args) {
        try {
            ...
            */
            ...
            IPluginManager pluginMan = VersioAppDaoManager.getDaoManagers().getPluginManager();
            ...
            */
             ...
             * IIdiomaManager idioma = VersioAppDaoManager.getDaoManagers().getIdiomaManager();
             * 
    ...
    public static EntityManager initDB() {
        ...
        prop.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost:5432/versioapp");
        prop.put("javax.persistence.jdbc.user", "versioapp");
        prop.put("javax.persistence.jdbc.password", "versioapp");

        prop.put("hibernate.connection.driver_class", "org.postgresql.Driver");
        prop.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/versioapp");
        prop.put("hibernate.connection.username", "versioapp");
        prop.put("hibernate.connection.password", "versioapp");
        ...
        emf = Persistence.createEntityManagerFactory("versioappPULocal", prop);

        EntityManager em = emf.createEntityManager();

        em.setFlushMode(FlushModeType.AUTO);
        
        VersioAppDaoManager.setDaoManagers(new VersioAppJPADaoManagers(em)); 
